...
\end{equation}
Notice how phases $\theta_{\alpha}$ of $\Delta_{\alpha}$ do not necessarily cancel in the multiband-case, unlike the one-band case.
This will lead to new physical effects with no counterpart in the one-band case, as follows.
